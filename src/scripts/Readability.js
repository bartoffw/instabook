...
function Readability(doc, options) {
  ...
  if (this._keepComments) {
    ...
    this.COMMENS_CLASSES_IDS_TO_CHANGE = {
      ...
      'conversation': 'ebook-comments-section',
      'comments_commentsSection_': 'ebook-comments-section',
      'o-comments-box__comment-header': 'comment-header',
      'o-comments-box__comment-author': 'comment-author',
      'o-comments-box__comment-short': 'comment-text',
      ...
      'o-comments-box__comment js-comment': 'comment-element',
...
Readability.prototype = {
  ...
  REGEXPS: {
    ...
    shareElements: /(\b|_)(share|sharedaddy|post-sharing)(\b|_)/i,
    comments: /comment|discussion|conversation|js-quote-selection-container|ebook-comments-section/i,
